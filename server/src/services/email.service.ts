...
const sendEmail = async ( email: string, subject: string, text: string, mjml:any ) => {
	try {
		...
		if ( mjmlOutput.errors.length ) {
			console.error( 'MJML Errors:', mjmlOutput.errors );
			return;
		}
...
<mjml>
  <mj-body>
    <mj-container>
      <mj-section>
        <mj-column>
          <mj-text font-size="24px" font-weight="bold">Verificação de Email</mj-text>
          <mj-text>Clique no botão a seguir para verificar seu email. Certifique-se de que o link abaixo não tenha expirado.</mj-text>
          <mj-button href="${ link }" background-color="#5a21cc" color="#fff">Confirmar Email</mj-button>
        </mj-column>
      </mj-section>
    </mj-container>
  </mj-body>
...
`;
	...
	return sendEmail( email, subject, text, mjml );
};
...
<mjml>
  <mj-body>
    <mj-container>
      <mj-section>
        <mj-column>
          <mj-text font-size="24px" font-weight="bold">Redefinição de Senha</mj-text>
          <mj-text>Clique no botão a seguir para redefinir sua senha. Certifique-se de que o link abaixo não tenha expirado.</mj-text>
          <mj-button href="${ link }" background-color="#5a21cc" color="#fff">Redefinir Senha</mj-button>
        </mj-column>
      </mj-section>
    </mj-container>
  </mj-body>
